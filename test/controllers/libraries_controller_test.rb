...
class LibrariesControllerTest < ActionController::TestCase
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post :create, library: { Release: @library.Release, author: @library.author, book_title: @library.book_title, price: @library.price, publisher: @library.publisher }
    end
  ...
  test "should update library" do
    patch :update, id: @library, library: { Release: @library.Release, author: @library.author, book_title: @library.book_title, price: @library.price, publisher: @library.publisher }
    assert_redirected_to library_path(assigns(:library))
  end
